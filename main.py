...
parser.add_argument('--update_step',
                    type=int,
                    default=10000,
                    help='Update step of loss function and laplacian graph')

parser.add_argument('--update_step_hr',
                    type=int,
                    default=10000,
                    help='Update step of loss function and laplacian graph')
...
parser.add_argument('--cl', default='r42')
parser.add_argument('--sl', default='r32')
...
for content_image, content_image_hr, content_mask, content_name in content_loader:
    ...
    for style_image, style_image_hr, style_mask, style_name in style_loader:
        ...
        opt_img = Variable(torch.randn(content_image.size()).type_as(
            content_image.data),
