...
output_dir = Path('output/2021-10-09_weight_gridsearch_ups2')
    ...
    for s in style_names:
        ...
        for cw in cw_rows:
            ...
            for lw in lw_cols:
                ...
                # o_path = f'exp/2021-10-07_cl[r42]_sl[r32]_up[1000]_2_cw[{cw}]_lw[{lw}]'
                o_path = f'exp/2021-10-09_cl[r42]_sl[r32]_up[50]_2_cw[{cw}]_lw[{lw}]'
